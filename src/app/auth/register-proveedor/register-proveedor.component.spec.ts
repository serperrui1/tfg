...
describe('Registroproveedor', () => {
  ...
  xdescribe('Crear proveedor', () => {
    it('Formulario proveedor: Datos enviados correctamente', () => {
      let email = component.registrarProveedorForm.controls['email']
      let nombre = component.registrarProveedorForm.controls['nombre']
      let apellidos = component.registrarProveedorForm.controls['apellidos']
      let password = component.registrarProveedorForm.controls['password']
      let password2 = component.registrarProveedorForm.controls['password2']
      let numeroTelefono = component.registrarProveedorForm.controls['numeroTelefono']
      let fechaNacimiento = component.registrarProveedorForm.controls['fechaNacimiento']
      let paisResidencia = component.registrarProveedorForm.controls['paisResidencia']
      let ciudad = component.registrarProveedorForm.controls['ciudad']
      let localidad = component.registrarProveedorForm.controls['localidad']
      let direccionResidencia = component.registrarProveedorForm.controls['direccionResidencia']
      let codigoPostal = component.registrarProveedorForm.controls['codigoPostal']
      let terminos = component.registrarProveedorForm.controls['terminos']
    ...
    xit('Formulario proveedor: Botón de submit funciona correctamente', () => {
      let email = component.registrarProveedorForm.controls['email']
      let nombre = component.registrarProveedorForm.controls['nombre']
      let apellidos = component.registrarProveedorForm.controls['apellidos']
      let password = component.registrarProveedorForm.controls['password']
    ...
    xit('Formulario proveedor: Datos enviados erroneos', () => {
      let email = component.registrarProveedorForm.controls['email']
      let nombre = component.registrarProveedorForm.controls['nombre']
      let apellidos = component.registrarProveedorForm.controls['apellidos']
      let password = component.registrarProveedorForm.controls['password']
